...
export const Footer = () => (
  <footer>
    <div className="flex w-screen items-center justify-center bg-[#F5A623] text-white mx-auto px-4 py-10 text-center">
      <div className="flex flex-col md:flex-col justify-between items-center text-center">
        <div className="text-center md:text-left">
          ...
          <p className="text-white/70 text-center">Made With ❤️ By <a href="https://github.com/Sai-Santosh-Pal" className="text-white">Sai Santosh Pal</a> and <a className="text-white">Tribhuvan Sanoria</a></p>
        </div>
