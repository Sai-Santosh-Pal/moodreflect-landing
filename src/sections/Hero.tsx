  ...
  return (
    <section className="flex flex-col gap-10 items-center justify-center md:flex-row h-full w-full mt-5">
        <div className="left w-[50%] flex flex-col">
            <p className="w-[fit-content] md:ml-[25%] md:text-left text-center section-title md:text-4xl text-4xl">Track Your Emotions. Understand Your Mind.</p>
            ...
            <div className="flex gap-4 justify-center items-center">
              ...
              <div className="flex gap-2 items-center w-full">
                <p className="cursor-pointer whitespace-nowrap w-full">Learn More</p>
